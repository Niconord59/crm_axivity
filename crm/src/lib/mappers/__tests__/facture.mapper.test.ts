  ...
  describe("mapToFacture", () => {
    it("should map complete Supabase record to Facture", () => {
      ...
      expect(facture).toEqual({
        ...
        notes: "Facture projet CRM",
        typeFacture: "unique",
        pourcentageAcompte: undefined,
        factureParentId: undefined,
        montantTotalProjet: undefined,
        devisId: undefined,
        niveauRelance: 1,
  ...
  describe("mapFactureToInsert", () => {
    it("should map complete Facture data to Supabase insert format", () => {
      ...
      expect(insertData).toEqual({
        ...
        notes: "New invoice",
        type_facture: "unique",
        pourcentage_acompte: undefined,
        facture_parent_id: undefined,
        montant_total_projet: undefined,
        devis_id: undefined,
        projet_id: "proj-123",
